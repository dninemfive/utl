...
public class GenericEnumerator<T> : IEnumerator<T>, IDisposable
{
    ...
    /// <summary>
    /// Resets the index such that the enumerator will yield the first element in the sequence after
    /// <see cref="MoveNext"/> is called.
    /// </summary>
    public void Reset() => _index = -1;
    /// <summary>
    /// Not implemented, as there are no additional resources to dispose. See <see
    /// href="https://learn.microsoft.com/en-us/dotnet/api/system.collections.generic.ienumerator-1?view=net-7.0#notes-to-implementers">
